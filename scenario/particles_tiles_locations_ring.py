...
def create_world(world):
    ...
    # 3rd ring
    world.add_location(3.000000, 0.000000, color=3)
    world.add_location(-3.000000, 0.000000, color=3)
    world.add_location(2.500000, 1.000000, color=3)
    world.add_location(2.500000, -1.000000, color=3)
    world.add_location(-2.500000, 1.000000, color=3)
    world.add_location(-2.500000, -1.000000, color=3)
    world.add_location(2.000000, 2.000000, color=3)
    world.add_location(2.000000, -2.000000, color=3)
    world.add_location(-2.000000, 2.000000, color=3)
    world.add_location(-2.000000, -2.000000, color=3)
    world.add_location(1.500000, 3.000000, color=3)
    world.add_location(1.500000, -3.000000, color=3)
    world.add_location(0.500000, 3.000000, color=3)
    world.add_location(0.500000, -3.000000, color=3)
    world.add_location(-0.500000, 3.000000, color=3)
    world.add_location(-0.500000, -3.000000, color=3)
    world.add_location(-1.500000, 3.000000, color=3)
